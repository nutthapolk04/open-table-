...
<template>
  <Modal
    ...
    :title="
      ...
      (table ? ` - ${t('posModule.table')} ${table.number}` : '')
    "
  >
      ...
      <div class="bg-slate-50 border border-slate-200 rounded-xl p-4">
        ...
        >
          <div v-if="table.orders && table.orders.length > 0">
            ...
            >
              <span class="text-slate-600 truncate mr-2 w-2/3"
        ...
        <div class="space-y-3 text-sm flex flex-col">
          <div
            class="flex justify-between text-slate-600 font-medium pb-2 border-b border-white"
          >
          ...
          <div class="flex items-center justify-between mb-2">
            ...
            <input
              ...
              type="number"
              min="0"
              class="w-24 text-right border border-red-200 bg-red-50 text-red-700 rounded px-2 py-1 focus:ring-1 focus:ring-red-400 outline-none h-7"
            />
          </div>
