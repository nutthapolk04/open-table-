...
async function autoSeed() {
    try {
        ...
        // ENSURE DEMO SESSION EXISTS FOR EASY TESTING
        const demoSession = await prisma.session.findUnique({ where: { id: 'demo' } });
        if (!demoSession) {
            ...
            if (firstTable && firstTier) {
                ...
                console.log('Demo session created with ID "demo"');
            }
        }
    } catch (error) {
